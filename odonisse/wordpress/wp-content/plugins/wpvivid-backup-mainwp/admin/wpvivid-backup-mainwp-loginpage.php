...
class Mainwp_WPvivid_Extension_LoginPage
{
    ...
    public function render()
    {
        ...
        if(isset($_REQUEST['switch'])) {
            ...
            if(isset($login_options['wpvivid_pro_login_cache']['pro_user']) && !empty($login_options['wpvivid_pro_login_cache']['pro_user'])){
        ...
        <script>
            ...
            function mwp_wpvivid_connect_account_and_active(){
                ...
                var pass = jQuery('#mwp_wpvivid_account_pw').val();
                var use_token = '1';
                ...
                mwp_wpvivid_post_request(ajax_data, function(data) {
                    ...
                    if (jsonarray.result === 'success') {
                        if(jsonarray.pro_user===1) {
                            ...
                            location.href='<?php echo apply_filters('wpvivid_get_admin_url', '') . 'admin.php?page=Extensions-Wpvivid-Backup-Mainwp&tab=login&login_success'?>';
                        }
                        else {
                            mwp_wpvivid_login_progress('You have successfully logged in');
                            location.href='<?php echo apply_filters('wpvivid_get_admin_url', '') . 'admin.php?page=Extensions-Wpvivid-Backup-Mainwp&tab=login&login_success'?>';
