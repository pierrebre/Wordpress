    ...
    static public function renderSetting()
    {
        ...
        <div style="background-color: #fff;">
            <div id="mwp_wpvivid_dashboard_tab">
                <?php
                $select_pro=$mainwp_wpvivid_extension_activator->get_global_select_pro();
                $setting_page=new Mainwp_WPvivid_Extension_DashboardPage($select_pro);
                $setting_page->render();
                ?>
            </div>
        </div>
    ...
    <?php } ?>
        ...
        <div style="background-color: #fff;">
            <div id="mwp_wpvivid_settings_tab">
                ...
                $select_pro=$mainwp_wpvivid_extension_activator->get_global_select_pro();
                $setting_page=new Mainwp_WPvivid_Extension_SettingPage($setting, $setting_addon, $select_pro);
                $setting_page->render(true, true);
                ?>
            </div>
        </div>
    <?php } ?>
        ...
        <div style="background-color: #fff;">
            <div id="mwp_wpvivid_scheduled_tab">
                ...
                $select_pro=$mainwp_wpvivid_extension_activator->get_global_select_pro();
                $setting_page=new Mainwp_WPvivid_Extension_SchedulePage($schedule, $schedule_addon, $custom_setting, 0, $select_pro);
                $setting_page->render(true, true);
                ?>
            </div>
        </div>
    <?php } ?>
        ...
        <div style="background-color: #fff;">
            <div id="mwp_wpvivid_remote_tab">
                ...
                $select_pro=$mainwp_wpvivid_extension_activator->get_global_select_pro();
                $setting_page=new Mainwp_WPvivid_Extension_RemotePage($remote, $remote_addon, $select_pro);
                $setting_page->render(true, true);
                ?>
            </div>
        </div>
        ...
        if($current_tab == 'login'){
            ...
            <div style="background-color: #fff;">
                <div id="mwp_wpvivid_login_tab" style="margin: 20px; background-color: #fff;">
                    <?php
                    $login_page = new Mainwp_WPvivid_Extension_LoginPage();
                    $login_page->render();
                    ?>
                </div>
            </div>
        ...
        if($current_tab == 'menu'){
            ...
            <div style="background-color: #fff;">
                <div id="mwp_wpvivid_menu_tab">
                    ...
                    $capability_page->render(true, true);
                    ?>
                </div>
            </div>
            <?php
        ...
        if($current_tab == 'white_label'){
            ...
            <div style="background-color: #fff;">
                <div id="mwp_wpvivid_white_label_tab">
                    ...
                    $white_label_page->render(true, true);
                    ?>
                </div>
            </div>
            <?php
